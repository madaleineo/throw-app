  ...
  return (
    <div className='flex flex-row'>
      <div className="bg-burnt-orange flex flex-col p-4 w-60 min-h-screen">
        ...
        <div className="p-2">
          <button className="p-2 flex flex-row hover:bg-hover-orange w-40">
      ...
      <div className="flex flex-col min-w-screen p-8">
        <div className="flex flex-row justify-between">
          ...
          <div>
            <button className="flex flex-row bg-plurple hover:bg-hover-plurple text-white p-2">
